...
with read_base():
    from .masklat_qwen3_4b_instruct_siglip2_so400m_p14_384_sam_large_m2f_gpu16_mixed_finetune import *
...
s2_pretrained_pth = (
    ...
    + "masklat_qwen3_4b_instruct_instruct_siglip2_so400m_p14_384_"

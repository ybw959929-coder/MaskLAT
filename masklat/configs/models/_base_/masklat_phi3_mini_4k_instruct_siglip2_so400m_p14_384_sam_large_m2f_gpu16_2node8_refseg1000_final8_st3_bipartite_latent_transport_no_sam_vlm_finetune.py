...
with read_base():
    from .masklat_phi3_mini_4k_instruct_siglip2_so400m_p14_384_sam_large_m2f_gpu16_2node8_refseg1000_final8_st3_bipartite_latent_transport_finetune import *


sample_ratio = float(getenv("S3_SAMPLE_RATIO", "0.1"))

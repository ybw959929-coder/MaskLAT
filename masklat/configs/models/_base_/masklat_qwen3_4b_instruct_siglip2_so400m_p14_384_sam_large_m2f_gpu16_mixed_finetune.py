...
from masklat.utils.template import PROMPT_TEMPLATE
...
s2_pretrained_pth = (
    work_dir
    + "s2_align_pretrain/masklat_qwen3_4b_instruct_instruct_siglip2_so400m_p14_384_sam_large_e1_gpu16_align_pretrain/pytorch_model.bin"
)  
...
evaluation_task_names = [
    "imgconv", "genseg", "refseg", "reaseg", "gcgseg",
    "intseg", "intseg", "intseg", "intseg",
    "vgdseg", "vgdseg", "vgdseg", "vgdseg", "vgdseg",
]
evaluation_inputs = [

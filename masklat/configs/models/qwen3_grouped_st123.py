"""MaskLAT training configuration with a Qwen3 language backbone."""
...
with read_base():
    from ._base_.masklat_qwen3_4b_group_supervised_latent_s3_full_refcoco2000_4node_text4096 import *


model = deepcopy(model)
checkpoint = getenv("MASKLAT_QWEN3_S2_CHECKPOINT")
if not checkpoint:
    raise ValueError("MASKLAT_QWEN3_S2_CHECKPOINT is required")
